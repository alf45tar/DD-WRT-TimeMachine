...
11. Create the folder to save the TimeMachine backups 
    ```
    cd /opt
    mkdir timemachine
...
12. Set Samba password for user `timemachine`
    ```
...
15. After reboot you are ready to backup your macOS devices with TimeMachine
